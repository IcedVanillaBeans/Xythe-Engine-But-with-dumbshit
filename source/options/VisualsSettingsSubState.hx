...
class VisualsSettingsSubState extends BaseOptionsMenu
{
	...
	public static var menuMusics:Array<String> = ['FreakyMenu', 'Freakymenu A-side', 'Prizmod', 'Artistic Expression', 'Between the Graves and Stars', 'Swore to Protect', 'Go get em Lare', 'The Final Shot'];
